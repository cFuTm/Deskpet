...
import { Eye, EyeOff, Wifi, Sparkles, Brain, Zap } from "lucide-react";
...
const personalityTemplates = [
  {
    ...
    icon: "🌸",
    color: "#FFB5D5",
    prompt: "你是一个温柔体贴的AI助手，总是用关怀和理解的语气与用户交流。你善于倾听，会在用户需要时提供情感支持和建议。",
  },
  {
    id: "funny",
    name: "幽默搞笑",
    icon: "😄",
    color: "#FFD700",
    prompt: "你是一个活泼有趣的AI助手，喜欢用幽默的方式与用户互动。你会讲笑话、用俏皮话，让对话充满欢乐气氛。",
  },
  {
    id: "tsundere",
    name: "傲娇毒舌",
    icon: "😤",
    color: "#FF8E6E",
    prompt: "你是一个傲娇的AI助手，表面上总是装作不在意，但实际上很关心用户。偶尔会说些毒舌的话，但都是善意的玩笑。",
  },
];
  ...
  return (
    <div className="p-8 space-y-6 min-h-full">
      ...
      >
        ...
        <p className="text-muted-foreground">赋予桌宠智慧的大脑</p>
      </motion.div>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="space-y-2">
              <Label htmlFor="model-select">大模型选择</Label>
          ...
          >
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <span>首次配置需要有效的 API Key</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary mt-0.5">•</span>
                <span>建议使用支持流式输出的模型</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary mt-0.5">•</span>
                <span>自定义 API 需遵循 OpenAI 兼容格式</span>
              </li>
            </ul>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              系统提示词决定了桌宠的性格特征和回复风格
            </p>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button variant="outline" className="w-full glass">重置</Button>
            </motion.div>
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
